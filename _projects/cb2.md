...
You may check my [Linkedin](https://linkedin.com/in/gregormihelac/)
...
<div class="row">
    <div class="col-sm mt-3 mt-md-0">
        {% include figure.liquid loading="eager" path="assets/img/cb/cb.pdf" title="me" class="img-fluid4 rounded z-depth-1" style="width=50%"%}
    </div>
</div>