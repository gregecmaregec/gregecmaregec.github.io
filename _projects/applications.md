...
<br>
<div class="caption">
    Example natural language questioning with Anthropic’s Claude. 
</div>
<div class="row">
    <div class="col-sm mt-3 mt-md-0">
        {% include figure.liquid loading="eager" path="assets/img/itfa/applications/claude2.jpg" title="claude is amazing" class="img-fluid rounded z-depth-1" %}
    </div>
</div>
<br>
<br>
...
<div class="row">
    <div class="col-sm mt-3 mt-md-0">
        {% include figure.liquid loading="eager" path="assets/img/itfa/applications/midjourney.jpg" title="LLMs making images" class="img-fluid rounded z-depth-1" %}
    </div>
</div>
<br>
<br>
